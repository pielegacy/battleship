...
namespace Battleships
{
	...
	static class DeploymentController
	{
        ...
        private const int MUTE_BUTTONS_TOP = 10;
        private const int MUTE_BUTTONS_LEFT = 720;
		private const int MUTE_BUTTONS_WIDTH = 40;
        private const int MUTE_BUTTONS_HEIGHT = 30;
        ...
        public static void HandleDeploymentInput()
		{
			...
			if (SwinGame.MouseClicked(MouseButton.LeftButton))
			{
                ...
                else if (UtilityFunctions.IsMouseInRectangle(MUTE_BUTTONS_LEFT, MUTE_BUTTONS_TOP, MUTE_BUTTONS_WIDTH, MUTE_BUTTONS_HEIGHT) && (Sound == true))
                {
                    SwinGame.StopMusic();
                    SwinGame.DrawBitmap(GameResources.GameImage("MuteButton"), MUTE_BUTTONS_LEFT, MUTE_BUTTONS_TOP);
                    Sound = false;
                }
                else if (UtilityFunctions.IsMouseInRectangle(MUTE_BUTTONS_LEFT, MUTE_BUTTONS_TOP, MUTE_BUTTONS_WIDTH, MUTE_BUTTONS_HEIGHT) && (Sound == false))
                {
                    SwinGame.PlayMusic(GameResources.GameMusic("Background"));
                    SwinGame.DrawBitmap(GameResources.GameImage("SoundButton"), MUTE_BUTTONS_LEFT, MUTE_BUTTONS_TOP);
                    Sound = true;
                }
                else
                {
